export function HeroSection({ code }: { code?: string }) {
  return (
    ...
    "
      ...
      <div className="mx-auto max-w-4xl text-center flex flex-col items-center gap-6">
        ...
        <p className="max-w-2xl text-base sm:text-lg text-white/80 leading-relaxed">
          DevImpact tracks how your work actually unfolds — across code,
          reviews, and meetings — so you’re never surprised at review time and
          never lose credit for your impact.
        </p>
